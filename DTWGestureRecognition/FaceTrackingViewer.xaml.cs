...
namespace DTWGestureRecognition
{
    ...
    public partial class FaceTrackingViewer : UserControl, IDisposable
    {
        ...
        public static EnumIndexableCollection<FeaturePoint, Vector3DF> facePointS3D;
        public static EnumIndexableCollection<AnimationUnit, float> animationUnits;
        public static bool meshDisabled = false;
        ...
        private void OnAllFramesReady(object sender, AllFramesReadyEventArgs allFramesReadyEventArgs)
        {
            ...
            try
            {
              ...
              //  {
             //       SkeletonExtractSkeletonFrameReady(sender, skeletonFrame);
              //  };
        ...
        private class SkeletonFaceTracker : IDisposable
        {
            ...
            private EnumIndexableCollection<FeaturePoint, Vector3DF> facePoints3DRaw;
            private EnumIndexableCollection<AnimationUnit, float> animationUnitsRaw;
